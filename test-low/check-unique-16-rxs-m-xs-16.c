...
#define XX_INFO \
            ...
            "      -  period:      2^16   (* #rngs  [unique stream per rng])\n" \
...
#define XX_SRANDOM(...)             \
            pcg_unique_16_srandom_r(&rng, __VA_ARGS__)
#define XX_RANDOM()                 \
            pcg_unique_16_rxs_m_xs_16_random_r(&rng)
#define XX_BOUNDEDRAND(bound)       \
            pcg_unique_16_rxs_m_xs_16_boundedrand_r(&rng, bound)
